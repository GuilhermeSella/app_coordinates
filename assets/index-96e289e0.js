 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const es=mA;function xS(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:cp,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw oi.create("bad-app-name",{appName:String(i)});if(n||(n=_S()),!n)throw oi.create("no-options");const s=hc.get(i);if(s){if(cc(n,s.options)&&cc(r,s.config))return s;throw oi.create("duplicate-app",{appName:i})}const o=new xR(i);for(const l of hp.values())o.addComponent(l);const a=new wA(n,r,o);return hc.set(i,a),a}function sg(t=cp){const e=hc.get(t);if(!e&&t===cp&&_S())return xS();if(!e)throw oi.create("no-app",{appName:t});return e}function Yn(t,e,n){var r;let i=(r=gA[t])!==null&&r!==void 0?r:t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${i}" with version "${e}":`];s&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Vi.warn(a.join(" "));return}Hi(new di(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iN=new sl(3e4,6e4);function a0(){const t=Xn().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function sN(t){return new Promise((e,n)=>{var r,i,s;function o(){a0(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{a0(),n(Jn(t,"network-request-failed"))},timeout:iN.get()})}if(!((i=(r=Xn().gapi)===null||r===void 0?void 0:r.iframes)===null||i===void 0)&&i.Iframe)e(gapi.iframes.getContext());else if(!((s=Xn().gapi)===null||s===void 0)&&s.load)o();else{const a=XA("iframefcb");return Xn()[a]=()=>{gapi.load?o():n(Jn(t,"network-request-failed"))},WS(`https://apis.google.com/js/api.js?onload=${a}`).catch(l=>n(l))}}).catch(e=>{throw xu=null,e})}let xu=null;function oN(t){return xu=xu||sN(t),xu}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eb{constructor(e){this.observer=e,this.muted=!1}next(e){this.observer.next&&this.Sc(this.observer.next,e)}error(e){this.observer.error?this.Sc(this.observer.error,e):Rr("Uncaught Error in snapshot listener:",e.toString())}Dc(){this.muted=!0}Sc(e,n){this.muted||setTimeout(()=>{this.muted||e(n)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hb(t){t=Yi(t,un);const e=Yi(t.firestore,Dh);return Ib(cC(e),t._key).then(n=>Gb(e,t,n))}class qb extends jb{constructor(e){super(),this.firestore=e}convertBytes(e){return new eo(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new un(this.firestore,null,n)}}function Kb(t,e,n){t=Yi(t,un);const r=Yi(t.firestore,Dh),i=zb(t.converter,e,n);return SC(r,[Lb(pC(r),"setDoc",t._key,i,t.converter!==null,n).toMutation(t._key,Zn.none())])}function Wb(t,e,n,...r){t=Yi(t,un);const i=Yi(t.firestore,Dh),s=pC(i);let o;return o=typeof(e=Ht(e))=="string"||e instanceof Oh?$b(s,"updateDoc",t._key,e,n,r):Mb(s,"updateDoc",t._key,e),SC(i,[o.toMutation(t._key,Zn.exists(!0))])}function SC(t,e){return function(n,r){const i=new ai;return n.asyncQueue.enqueueAndForget(async()=>cb(await Cb(n),r,i)),i.promise}(cC(t),e)}function Gb(t,e,n){const r=n.docs.get(e._key),i=new qb(t);return new EC(t,i,e._key,r,new Bb(n.hasPendingWrites,n.fromCache),e.converter)}(function(t,e=!0){(function(n){mo=n})(es),Hi(new di("firestore",(n,{instanceIdentifier:r,options:i})=>{const s=n.getProvider("app").getImmediate(),o=new Dh(new qD(n.getProvider("auth-internal")),new QD(n.getProvider("app-check-internal")),function(a,l){if(!Object.prototype.hasOwnProperty.apply(a.options,["projectId"]))throw new Y(D.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ba(a.options.projectId,l)}(s,r),s);return i=Object.assign({useFetchStreams:e},i),o._setSettings(i),o},"PUBLIC").setMultipleInstances(!0)),Yn(x0,"3.13.0",t),Yn(x0,"3.13.0","esm2017")})();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
${this.customData.serverResponse}`:this.message=this._baseMessage}}var rr;(function(t){t.UNKNOWN="unknown",t.OBJECT_NOT_FOUND="object-not-found",t.BUCKET_NOT_FOUND="bucket-not-found",t.PROJECT_NOT_FOUND="project-not-found",t.QUOTA_EXCEEDED="quota-exceeded",t.UNAUTHENTICATED="unauthenticated",t.UNAUTHORIZED="unauthorized",t.UNAUTHORIZED_APP="unauthorized-app",t.RETRY_LIMIT_EXCEEDED="retry-limit-exceeded",t.INVALID_CHECKSUM="invalid-checksum",t.CANCELED="canceled",t.INVALID_EVENT_NAME="invalid-event-name",t.INVALID_URL="invalid-url",t.INVALID_DEFAULT_BUCKET="invalid-default-bucket",t.NO_DEFAULT_BUCKET="no-default-bucket",t.CANNOT_SLICE_BLOB="cannot-slice-blob",t.SERVER_FILE_WRONG_SIZE="server-file-wrong-size",t.NO_DOWNLOAD_URL="no-download-url",t.INVALID_ARGUMENT="invalid-argument",t.INVALID_ARGUMENT_COUNT="invalid-argument-count",t.APP_DELETED="app-deleted",t.INVALID_ROOT_OPERATION="invalid-root-operation",t.INVALID_FORMAT="invalid-format",t.INTERNAL_ERROR="internal-error",t.UNSUPPORTED_ENVIRONMENT="unsupported-environment"})(rr||(rr={}));function tf(t){return"storage/"+t}function Xb(){const t="An unknown error occurred, please check the error payload for server response.";return new or(rr.UNKNOWN,t)}function Zb(){return new or(rr.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function eL(){return new or(rr.CANCELED,"User canceled the upload/download.")}function tL(t){return new or(rr.INVALID_URL,"Invalid URL '"+t+"'.")}function nL(t){return new or(rr.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+t+"'.")}function ow(t){return new or(rr.INVALID_ARGUMENT,t)}function TC(){return new or(rr.APP_DELETED,"The Firebase app was deleted.")}function rL(t){return new or(rr.INVALID_ROOT_OPERATION,"The operation '"+t+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const CC="storage";function EL(t=sg(),e){t=Ht(t);const r=rh(t,CC).getImmediate({identifier:e}),i=SS("storage");return i&&SL(r,...i),r}function SL(t,e,n,r={}){vL(t,e,n,r)}function _L(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),r=t.getProvider("auth-internal"),i=t.getProvider("app-check-internal");return new wL(n,r,i,e,es)}function TL(){Hi(new di(CC,_L,"PUBLIC").setMultipleInstances(!0)),Yn(uw,cw,""),Yn(uw,cw,"esm2017")}TL();const CL={apiKey:"AIzaSyDjp2naVdYBa2RhxnnLuiDBo3Y1kJvg3Ro",authDomain:"coordinates-10459.firebaseapp.com",projectId:"coordinates-10459",storageBucket:"coordinates-10459.appspot.com",messagingSenderId:"17389845792",appId:"1:17389845792:web:324711e8abcbb7c6aeeb45",measurementId:"G-C4T1LXJLHM"},fy=xS(CL),hw=ON(fy),Hp=Nb(fy);EL(fy);/**
...
`;function G$(t){const{toggleHamburguer:e}=x.useContext(ir);return S.jsxs(W$,{class:"menu-hamburguer",children:[S.jsx("input",{onChange:e,type:"checkbox",id:"menu-hamburguer",class:"input-menu-hamburguer"}),S.jsx("label",{htmlFor:"menu-hamburguer",children:S.jsx("div",{class:"menu",children:S.jsx("span",{class:"hamburguer"})})})]})}const Q$=Wt.header`
...
`;function X$(){const{hamburguer:t,toggleHamburguer:e}=x.useContext(ir);return S.jsx(J$,{hamburguer:t,children:S.jsxs("ul",{children:[S.jsxs("li",{children:[S.jsx("span",{class:"material-symbols-outlined",children:"home"}),S.jsx(Zt,{to:"/home",children:"Home"})]}),S.jsxs("li",{children:[S.jsx("span",{class:"material-symbols-outlined",children:"person"}),S.jsx(Zt,{to:"/home/account",children:"Profile"})]}),S.jsxs("li",{children:[S.jsx("span",{class:"material-symbols-outlined",children:"bookmark"}),S.jsx(Zt,{to:"/home/saved",children:"Saved"})]}),S.jsxs("li",{children:[S.jsx("span",{class:"material-symbols-outlined",children:"logout"}),S.jsx(Zt,{onClick:()=>{navigate("/"),LogOut()},children:"Log Out"})]})]})})}function Z$(){return S.jsxs(S.Fragment,{children:[S.jsx(Y$,{}),S.jsx(X$,{}),S.jsx(DM,{}),S.jsx(K$,{})]})}const eF=Wt.div`
      background-color: ${t=>t.theme==="light"?"white":"#0a0a0af7"};
