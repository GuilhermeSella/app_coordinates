 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qt(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function HA(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(qt())}function qA(){var t;const e=(t=Ph())===null||t===void 0?void 0:t.forceEnvironment;if(e==="node")return!0;if(e==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function WA(){const t=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof t=="object"&&t.id!==void 0}function KA(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function GA(){const t=qt();return t.indexOf("MSIE ")>=0||t.indexOf("Trident/")>=0}function QA(){try{return typeof indexedDB=="object"}catch{return!1}}function YA(){return new Promise((t,e)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(r);i.onsuccess=()=>{i.result.close(),n||self.indexedDB.deleteDatabase(r),t(!0)},i.onupgradeneeded=()=>{n=!1},i.onerror=()=>{var s;e(((s=i.error)===null||s===void 0?void 0:s.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vt{constructor(e,n,r){this.converter=n,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new wi(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Vt(this.firestore,e,this._key)}}class Po{constructor(e,n,r){this.converter=n,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new Po(this.firestore,e,this._query)}}class wi extends Po{constructor(e,n,r){super(e,n,Yh(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Vt(this.firestore,null,new J(e))}withConverter(e){return new wi(this.firestore,e,this._path)}}function BC(t,e,...n){if(t=st(t),jC("collection","path",e),t instanceof od){const r=Be.fromString(e,...n);return Uw(r),new wi(t,null,r)}{if(!(t instanceof Vt||t instanceof wi))throw new W(N.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(Be.fromString(e,...n));return Uw(r),new wi(t.firestore,null,r)}}function vo(t,e,...n){if(t=st(t),arguments.length===1&&(e=$T.A()),jC("doc","path",e),t instanceof od){const r=Be.fromString(e,...n);return Fw(r),new Vt(t,null,new J(r))}{if(!(t instanceof Vt||t instanceof wi))throw new W(N.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(Be.fromString(e,...n));return Fw(r),new Vt(t.firestore,t instanceof wi?t.converter:null,new J(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gw(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(cI(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(lI(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(dI(e))return"Blackberry";if(fI(e))return"Webos";if(Zy(e))return"Safari";if((e.includes("chrome/")||uI(e))&&!e.includes("edge/"))return"Chrome";if(hI(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=t.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function lI(t=qt()){return/firefox\//i.test(t)}function Zy(t=qt()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function uI(t=qt()){return/crios\//i.test(t)}function cI(t=qt()){return/iemobile/i.test(t)}function hI(t=qt()){return/android/i.test(t)}function dI(t=qt()){return/blackberry/i.test(t)}function fI(t=qt()){return/webos/i.test(t)}function dd(t=qt()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function FD(t=qt()){var e;return dd(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function UD(){return GA()&&document.documentMode===10}function pI(t=qt()){return dd(t)||hI(t)||fI(t)||dI(t)||/windows phone/i.test(t)||cI(t)}function jD(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function u$(t,e){return e}class Kt{constructor(e,n,r,i){this.server=e,this.local=n||e,this.writable=!!r,this.xform=i||u$}}let Mu=null;function c$(t){return!sv(t)||t.length<2?t:zI(t)}function VI(){if(Mu)return Mu;const t=[];t.push(new Kt("bucket")),t.push(new Kt("generation")),t.push(new Kt("metageneration")),t.push(new Kt("name","fullPath",!0));function e(s,o){return c$(o)}const n=new Kt("name");n.xform=e,t.push(n);function r(s,o){return o!==void 0?Number(o):o}const i=new Kt("size");return i.xform=r,t.push(i),t.push(new Kt("timeCreated")),t.push(new Kt("updated")),t.push(new Kt("md5Hash",null,!0)),t.push(new Kt("cacheControl",null,!0)),t.push(new Kt("contentDisposition",null,!0)),t.push(new Kt("contentEncoding",null,!0)),t.push(new Kt("contentLanguage",null,!0)),t.push(new Kt("contentType",null,!0)),t.push(new Kt("metadata","customMetadata",!0)),Mu=t,Mu}function h$(t,e){function n(){const r=t.bucket,i=t.fullPath,s=new pn(r,i);return e._makeStorageReference(s)}Object.defineProperty(t,"ref",{get:n})}function d$(t,e,n){const r={};r.type="file";const i=n.length;for(let s=0;s<i;s++){const o=n[s];r[o.local]=o.xform(r,e[o.server])}return h$(r,t),r}function HI(t,e,n){const r=BI(e);return r===null?null:d$(t,r,n)}function f$(t,e,n,r){const i=BI(e);if(i===null||!sv(i.downloadTokens))return null;const s=i.downloadTokens;if(s.length===0)return null;const o=encodeURIComponent;return s.split(",").map(u=>{const c=t.bucket,h=t.fullPath,d="/b/"+o(c)+"/o/"+o(h),f=av(d,n,r),m=$I({alt:"media",token:u});return f+m})[0]}function p$(t,e){const n={},r=e.length;for(let i=0;i<r;i++){const s=e[i];s.writable&&(n[s.server]=t[s.local])}return JSON.stringify(n)}class qI{constructor(e,n,r,i){this.url=e,this.method=n,this.handler=r,this.timeout=i,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`;function xU(){return _.jsx(kU,{children:_.jsxs("p",{children:["@2023 Coordinates - Made by ",_.jsx("a",{href:"https://github.com/GuilhermeSella",children:"Guilherme Sella"})]})})}const RU=Wt.div`
    padding-bottom: 10px;
...
`;function AU(t){const{toggleHamburguer:e,theme:n}=T.useContext(Qn);return _.jsxs(RU,{className:"menu-hamburguer",theme:n,children:[_.jsx("input",{onChange:e,type:"checkbox",id:"menu-hamburguer",className:"input-menu-hamburguer"}),_.jsx("label",{htmlFor:"menu-hamburguer",children:_.jsx("div",{className:"menu",children:_.jsx("span",{className:"hamburguer"})})})]})}const bU=Wt.header`
...
`;function NU(){const{theme:t}=T.useContext(Qn),{LogOut:e}=T.useContext(Bo),n=jo();return _.jsxs(bU,{theme:t,children:[_.jsx("div",{children:_.jsx(Xt,{to:"/home",children:"Coordinates"})}),_.jsxs("nav",{className:"navIcons",children:[_.jsx(Xt,{className:"button",to:"/home/account",children:_.jsx("span",{className:"material-symbols-outlined",children:"person"})}),_.jsx(Xt,{className:"button",to:"/home/saved",children:_.jsx("span",{className:"material-symbols-outlined",children:"bookmark"})}),_.jsx(Xt,{className:"button",onClick:()=>{n("/"),e()},children:_.jsx("span",{className:"material-symbols-outlined",children:"logout"})}),_.jsx("div",{className:"menuH",children:_.jsx(AU,{})})]})]})}const PU=Wt.div`
...
`;function OU(){const{theme:t,hamburguer:e,toggleHamburguer:n}=T.useContext(Qn),{LogOut:r}=T.useContext(Bo),i=jo();return _.jsx(PU,{hamburguer:e,theme:t,children:_.jsxs("ul",{children:[_.jsxs("li",{onClick:n,children:[_.jsx("span",{className:"material-symbols-outlined",children:"home"}),_.jsx(Xt,{to:"/home",children:"Home"})]}),_.jsxs("li",{onClick:n,children:[_.jsx("span",{className:"material-symbols-outlined",children:"person"}),_.jsx(Xt,{to:"/home/account",children:"Profile"})]}),_.jsxs("li",{onClick:n,children:[_.jsx("span",{className:"material-symbols-outlined",children:"bookmark"}),_.jsx(Xt,{to:"/home/saved",children:"Saved"})]}),_.jsxs("li",{onClick:n,children:[_.jsx("span",{className:"material-symbols-outlined",children:"logout"}),_.jsx(Xt,{onClick:()=>{i("/"),r()},children:"Log Out"})]})]})})}function DU(){const{hamburguer:t,setTheme:e}=T.useContext(Qn);function n(){const r=JSON.parse(localStorage.getItem("@userStorage"));r&&e(r.theme)}return T.useEffect(()=>{n()},[]),_.jsxs(_.Fragment,{children:[_.jsx(NU,{}),t==="disable"?_.jsxs(_.Fragment,{children:[_.jsx(GF,{}),_.jsx(xU,{})]}):_.jsx(OU,{})]})}const LU=Wt.div`
      background-color: ${t=>t.theme==="light"?"white":"#0a0a0aea"};
...
`,F3="/app_coordinates/assets/login-3e19d223.svg";function U3(t){const[e,n]=T.useState(),[r,i]=T.useState(),{signIn:s,loadingAuth:o,setLoadingAuth:a}=T.useContext(Bo),l=jo();async function u(c){c.preventDefault(),e!==""&&r!==""&&await s(e,r).then(h=>{l("/home"),ke.success("Bem vindo de volta!")}).catch(h=>{ke.error("Email ou senha inválidos!"),a(!1)})}return _.jsxs(ix,{children:[_.jsx(eu,{}),_.jsx("div",{className:"Divform",children:_.jsxs("form",{onSubmit:u,children:[_.jsx("h1",{children:"Sign in"}),_.jsxs("div",{children:[_.jsx("label",{children:"Email"}),_.jsx("input",{type:"email",required:"",onChange:c=>n(c.target.value)})]}),_.jsxs("div",{children:[_.jsx("label",{children:"Password"}),_.jsx("input",{type:"password",name:"",id:"",required:"",onChange:c=>i(c.target.value)})]}),_.jsx("button",{type:"submit",children:o===!0?"Loading...":"Sign in"}),_.jsxs("p",{children:["Ou ",_.jsx(Xt,{to:"/signup",children:"cadastre-se"})]})]})}),_.jsx("div",{className:"img",children:_.jsx("img",{src:F3,alt:""})})]})}const j3="/app_coordinates/assets/signup-89f45dbd.svg";function B3(){const[t,e]=T.useState(""),[n,r]=T.useState(""),[i,s]=T.useState(""),[o,a]=T.useState(""),{signUp:l,loadingAuth:u,setLoadingAuth:c}=T.useContext(Bo),h=jo();async function d(f){f.preventDefault(),t!==""&&n!==""&&i!==""&&o!==""&&i===o?await l(t,n,i).then(()=>{h("/home"),ke.success("Bem vindo!")}).catch(m=>{console.log(m.code),m.code==="auth/weak-password"?(ke.error("Senha muito fraca! "),c(!1)):m.code==="auth/email-already-in-use"&&(ke.error("Email já cadastrado!"),c(!1))}):i!==o?ke.error("As senhas não coincidem!"):ke.error("Preencha todos os campos!")}return _.jsxs(ix,{children:[_.jsx(eu,{}),_.jsx("div",{className:"Divform",children:_.jsxs("form",{onSubmit:d,children:[_.jsx("h1",{children:"Sign Up"}),_.jsxs("div",{children:[_.jsx("label",{children:"Nome"}),_.jsx("input",{type:"text",id:"txtnome",onChange:f=>e(f.target.value)})]}),_.jsxs("div",{children:[_.jsx("label",{children:"Email"}),_.jsx("input",{type:"text",id:"txtemail",onChange:f=>r(f.target.value)})]}),_.jsxs("div",{children:[_.jsx("label",{children:"Password"}),_.jsx("input",{type:"password",name:"",id:"txtpass",onChange:f=>s(f.target.value)})]}),_.jsxs("div",{children:[_.jsx("label",{children:"Confirm password"}),_.jsx("input",{type:"password",name:"",id:"",onChange:f=>a(f.target.value)})]}),_.jsx("button",{type:"submit",children:u===!0?"Loading...":"Sign up"}),_.jsxs("p",{children:["Já possui uma conta? ",_.jsx(Xt,{to:"/signin",children:"Login"})]})]})}),_.jsx("div",{className:"img",children:_.jsx("img",{src:j3,alt:""})})]})}const z3=Wt.main`
  background-color: ${t=>t.theme==="light"?"white":"#0a0a0aea"};
  width: 100%;
  display: flex;
  flex-direction: column;
...
`;function Q3(){return _.jsxs(G3,{children:[_.jsx("img",{src:K3,alt:""}),_.jsx("h1",{children:"Page not found"}),_.jsxs("p",{children:["Back to ",_.jsx(Xt,{to:"/home",children:"Home"})," "]})]})}const Y3=Wt.main`
